    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div id="modalSizes" class="mb-2 col-md-12"><br>
                ...
                <hr>
                <h5><b>Apakah Anda Yakin Ingin Menghapus Data User <span style="color:brown font-weight:bold"><?php echo $row['nama_admin'];  ?></span></b></h5>
                <div class="card-body">
                    <a href="?pages=user_admin&aksi=proses_hapus&id=<?php echo $row['id_user'];  ?>" class="btn btn-primary" name="Hapus">Hapus Data </a>
                    <a href="?pages=user_admin" type="reset" class="btn btn-danger" name="Hapus">Cancel</a>
