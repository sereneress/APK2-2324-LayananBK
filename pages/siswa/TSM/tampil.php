...
<div class="row">
    ...
    <!-- TAMPIL X Teknik Spedah Motor  -->

    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> X-Teknik Spedah Motor</h1>
            <div class="card-body">
    ...
    <!-- ENDD TAMPIL X Teknik Spedah Motor  -->


    <!-- TAMPIL XI Teknik Spedah Motor  -->

    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> XI-Teknik Spedah Motor</h1>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered first">
                        <div class="add_button">
    ...
    <!-- ENDD TAMPIL XI Teknik Spedah Motor  -->

    <!-- TAMPIL XII Teknik Spedah Motor  -->

    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> XII-Teknik Spedah Motor</h1>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered first">
                        <div class="add_button">
    ...
    <!-- ENDD TAMPIL XII Teknik Spedah Motor  -->
