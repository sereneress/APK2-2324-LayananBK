<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Teknik Komputer Dan Jaringan 1</h2>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="?index.php" class="breadcrumb-link">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="?index.php" class="breadcrumb-link">Tables</a></li>
                        <li class="active">Tampil Siswa Teknik Komputer Jaringan</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="row">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> X- Teknik Komputer Jaringan 1</h1>
            <div class="card-body">
    ...
    <!-- ENDD TAMPIL X Teknik Komputer Jaringan 1  -->


    <!-- TAMPIL XI Teknik Komputer Jaringan 1  -->

    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> XI-Teknik Komputer Jaringan 1</h1>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered first">
                        <div class="add_button">
    ...
    <!-- ENDD TAMPIL XI Teknik Komputer Jaringan 1  -->

    <!-- TAMPIL XII Teknik Komputer Jaringan  -->

    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> XII-Teknik Komputer Jaringan </h1>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered first">
                        <div class="add_button">
    ...
    <!-- ENDD TAMPIL XII Teknik Komputer Jaringan  -->
