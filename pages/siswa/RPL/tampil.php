<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Rekayasa Perangkat Lunak</h2>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="?index.php" class="breadcrumb-link">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="?index.php" class="breadcrumb-link">Tables</a></li>
                        <li class="active">Tampil Siswa Rekayasa Perangkat Lunak</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="row">
    ...
    <!-- TAMPIL X Rekayasa Perangkat Lunak  -->

    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> X-Rekayasa Perangkat Lunak</h1>
            <div class="card-body">
    ...
    <!-- ENDD TAMPIL X Rekayasa Perangkat Lunak  -->


    <!-- TAMPIL XI Rekayasa Perangkat Lunak  -->

    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> XI-Rekayasa Perangkat Lunak</h1>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered first">
                        <div class="add_button">
    ...
    <!-- ENDD TAMPIL XI Rekayasa Perangkat Lunak  -->

    <!-- TAMPIL XII Rekayasa Perangkat Lunak  -->

    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> XII-Rekayasa Perangkat Lunak</h1>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered first">
                        <div class="add_button">
    ...
    <!-- ENDD TAMPIL XII Rekayasa Perangkat Lunak  -->
