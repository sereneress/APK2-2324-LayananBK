...
<div class="row">
    ...
    <!-- TAMPIL X PERHOTELAN 2  -->

    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> X-Perhotelan 2</h1>
            <div class="card-body">
    ...
    <!-- ENDD TAMPIL X PERHOTELAN 2  -->


    <!-- TAMPIL XI PERHOTELAN 2  -->

    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> XI-Perhotelan 2</h1>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered first">
                        <div class="add_button">
    ...
    <!-- ENDD TAMPIL XI PERHOTELAN 2  -->

    <!-- TAMPIL XII PERHOTELAN 2  -->

    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card"> 
            <h1 class="card-header"> XII-Perhotelan 2</h1>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered first">
                        <div class="add_button">
